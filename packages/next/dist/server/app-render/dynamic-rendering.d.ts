...
import type { WorkUnitStore, PrerenderStoreModern, PrerenderStoreModernRuntime } from '../app-render/work-unit-async-storage.external';
...
export declare function getStaticShellDisallowedDynamicReasons(workStore: WorkStore, prelude: PreludeState, dynamicValidation: DynamicValidationState): Array<Error>;
