...
export type FindComponentsResult<NextModule extends GenericComponentMod = GenericComponentMod> = {
...
export type LoadedRenderOpts<NextModule extends GenericComponentMod = GenericComponentMod> = RenderOpts & LoadComponentsReturnType<NextModule> & RequestLifecycleOpts;
...
export default abstract class Server<ServerOptions extends Options = Options, ServerRequest extends BaseNextRequest = BaseNextRequest, ServerResponse extends BaseNextResponse = BaseNextResponse> {
    ...
    private readonly isCacheComponentsEnabled;
    /**
    ...
    protected run(req: ServerRequest, res: ServerResponse, parsedUrl: NextUrlWithParsedQuery): Promise<void>;
    private runImpl;
    private pipe;
    private pipeImpl;
    ...
    protected abstract getFallbackErrorComponents(url?: string): Promise<LoadComponentsReturnType<ErrorModule> | null>;
