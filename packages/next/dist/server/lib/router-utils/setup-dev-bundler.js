...
async function startWatcher(opts) {
                ...
                if (isAppPath) {
                    ...
                    if (useFileSystemPublicRoutes) {
                        ...
                        if (appDir && (0, _ismetadataroute.isStaticMetadataFile)(fileName.replace(appDir, ''))) {
                            ...
                            const segment = _path.default.posix.dirname(pageName);
                            const lastSegment = _path.default.posix.basename(pageName);
                            const normalizedPath = (0, _getmetadataroute.fillMetadataSegment)(segment, {}, lastSegment, true);
         ...
         */ if (/[\\\\/]_middleware$/.test(pageName)) {
            ...
            try {
                ...
                if (enabledTypeScript) {
                    ...
                    await (0, _routetypesutils.writeValidatorFile)(routeTypesManifest, validatorFilePath, Boolean(nextConfig.experimental.strictRouteTypes));
    ...
    async function requestHandler(req, res) {
        const parsedUrl = (0, _url.parseUrl)(req.url || '/');
        ...
        if (pathname !== null && (pathname.includes(devMiddlewareManifestPath) || pathname.includes(devTurbopackMiddlewareManifestPath))) {
