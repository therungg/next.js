...
class Server {
        ...
        try {
            ...
            if (useMatchedPathHeader) {
                try {
                    ...
                    if (this.isCacheComponentsEnabled && this.minimalMode && req.headers[_constants2.NEXT_RESUME_HEADER] === '1' && req.method === 'POST') {
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isCacheComponentsEnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
