...
import { type IncrementalResponseCacheEntry } from './response-cache';
...
export default class NextNodeServer extends BaseServer<Options, NodeNextRequest, NodeNextResponse> {
    ...
    protected getFallbackErrorComponents(_url?: string): Promise<LoadComponentsReturnType<ErrorModule> | null>;
