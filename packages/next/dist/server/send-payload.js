...
async function sendRenderResult({ req, res, result, generateEtags, poweredByHeader, cacheControl, cdnCacheControlHeader }) {
    ...
    if (cacheControl && !res.getHeader('Cache-Control')) {
        (0, _cachecontrol.setResponseCacheControlHeaders)(res, cacheControl, cdnCacheControlHeader);
    }
