...
import { PAGES_MANIFEST, BUILD_ID_FILE, MIDDLEWARE_MANIFEST, PRERENDER_MANIFEST, ROUTES_MANIFEST, CLIENT_PUBLIC_FILES_PATH, APP_PATHS_MANIFEST, SERVER_DIRECTORY, NEXT_FONT_MANIFEST, UNDERSCORE_NOT_FOUND_ROUTE_ENTRY, FUNCTIONS_CONFIG_MANIFEST } from '../shared/lib/constants';
    ...
    async loadNodeMiddleware() {
        if (!process.env.NEXT_MINIMAL) {
            try {
                ...
                const functionsConfig = this.renderOpts.dev ? {} : require(join(/* turbopackIgnore: true */ this.distDir, 'server', FUNCTIONS_CONFIG_MANIFEST));
