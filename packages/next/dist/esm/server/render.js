/* eslint-disable @next/internal/no-ambiguous-jsx -- Pages router doesn't use react-server */ import { jsx as _jsx, jsxs as _jsxs, Fragment as _Fragment } from "react/jsx-runtime";
...
import { GSP_NO_RETURNED_VALUE, GSSP_COMPONENT_MEMBER_ERROR, GSSP_NO_RETURNED_VALUE, STATIC_STATUS_PAGE_GET_INITIAL_PROPS_ERROR, SERVER_PROPS_GET_INIT_PROPS_CONFLICT, SERVER_PROPS_SSG_CONFLICT, SSG_GET_INITIAL_PROPS_CONFLICT, UNSTABLE_REVALIDATE_RENAME_ERROR, HTML_CONTENT_TYPE_HEADER, JSON_CONTENT_TYPE_HEADER } from '../lib/constants';
...
export async function renderToHTMLImpl(req, res, pathname, query, renderOpts, extra, sharedContext, renderContext) {
    ...
    if (isAutoExport && !dev && isExperimentalCompile) {
        setResponseCacheControlHeaders(res, {
            revalidate: false,
            expire: expireTime
    ...
    const document = /*#__PURE__*/ _jsx(HtmlContext.Provider, {
        value: htmlProps,
