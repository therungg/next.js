   ...
   */ let MaybeComponent = LayoutOrPage;
    ...
    if (!MaybeComponent) {
        return createSeedData(ctx, createElement(Fragment, {
            key: cacheNodeKey
        }, layerAssets, parallelRouteProps.children), parallelRouteCacheNodeSeedData, loadingData, isPossiblyPartialResponse, hasRuntimePrefetch);
    }
    ...
    if (isPage) {
        ...
        return createSeedData(ctx, createElement(Fragment, {
            key: cacheNodeKey
        }, wrappedPageElement, layerAssets, MetadataOutlet ? createElement(MetadataOutlet, null) : null), parallelRouteCacheNodeSeedData, loadingData, isPossiblyPartialResponse, hasRuntimePrefetch);
    } else {
        ...
        return createSeedData(ctx, wrappedSegmentNode, parallelRouteCacheNodeSeedData, loadingData, isPossiblyPartialResponse, hasRuntimePrefetch);
    }
}
...
function createSeedData(ctx, rsc, parallelRoutes, loading, isPossiblyPartialResponse, hasRuntimePrefetch) {
    if (loading !== null) {
