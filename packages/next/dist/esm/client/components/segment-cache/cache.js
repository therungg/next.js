...
import { getRouteVaryPath, getFulfilledRouteVaryPath, getSegmentVaryPathForRequest, appendLayoutVaryPath, finalizeLayoutVaryPath, finalizePageVaryPath, clonePageVaryPathWithNewSearchParams, finalizeMetadataVaryPath, getPartialPageVaryPath, getPartialLayoutVaryPath } from './vary-path';
...
export async function fetchSegmentOnCacheMiss(route, segmentCacheEntry, routeKey, tree) {
    ...
    try {
        ...
        return {
            value: fulfillSegmentCacheEntry(segmentCacheEntry, serverData.rsc, // TODO: The server does not currently provide per-segment stale time.
