...
export function navigateReducer(state, action) {
    ...
    const result = navigateUsingSegmentCache(url, currentUrl, currentRenderedSearch, state.cache, state.tree, state.nextUrl, FreshnessPolicy.Default, shouldScroll, mutable);
