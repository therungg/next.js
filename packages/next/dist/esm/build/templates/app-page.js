...
import { getFallbackRouteParams, createOpaqueFallbackRouteParams } from '../../server/request/fallback-params';
...
import { CachedRouteKind, IncrementalCacheKind } from '../../server/response-cache';
import { FallbackMode, parseFallbackField } from '../../lib/fallback';
import RenderResult from '../../server/render-result';
import { CACHE_ONE_YEAR, HTML_CONTENT_TYPE_HEADER, NEXT_CACHE_TAGS_HEADER, NEXT_RESUME_HEADER } from '../../lib/constants';
...
export async function handler(req, res, ctx) {
   ...
   */ const couldSupportPPR = !!nextConfig.cacheComponents;
