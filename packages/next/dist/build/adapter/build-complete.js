    ...
    if (typeof adapterMod.onBuildComplete === 'function') {
        ...
        if (config.output === 'export') {
            ...
            for(const route in prerenderManifest.routes){
                ...
                const { initialExpireSeconds: initialExpiration, initialRevalidateSeconds: initialRevalidate, initialHeaders, initialStatus, dataRoute, renderingMode, allowHeader, experimentalBypassFor } = prerenderManifest.routes[route];
                ...
                if (dataRoute) {
                    ...
                    if (isAppPage) {
                        ...
                        // route.
                        dataFilePath = _path.default.join(appDistDir, dataRoute);
                    }
            ...
            for(const dynamicRoute in prerenderManifest.dynamicRoutes){
                ...
                const { fallback, fallbackExpire, fallbackRevalidate, fallbackHeaders, fallbackStatus, fallbackSourceRoute, allowHeader, dataRoute, renderingMode, experimentalBypassFor } = prerenderManifest.dynamicRoutes[dynamicRoute];
                    ...
                    onMatch: [
                        {
                            ...
                            headers: {
                                'cache-control': `public,max-age=${_constants1.CACHE_ONE_YEAR},immutable`
                            }
                        }
                    ],
